...
def cmd_run(a, cfg, dry, token):
    ...
    if research_proc is not None:
        ...
        _fin(findings.exists(), "findings file" if findings.exists() else "no findings")
    if not dry:
